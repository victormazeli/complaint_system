                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg- col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Comlaints Infomation</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="card border-3 border-top border-top-primary">
                                <div class="card-body">
                             <?php                    
                            $rt = mysqli_query($conn,"SELECT * FROM complaint WHERE complainant_id='".$_SESSION['id']."' AND status = 0");
                            ...
                            <div class="card border-3 border-top border-top-primary">
                                <div class="card-body">
                             <?php                    
                            $rt = mysqli_query($conn,"SELECT * FROM complaint WHERE complainant_id='".$_SESSION['id']."' AND status = 1");
                            $num1 = mysqli_num_rows($rt);
                            {?>
                                        <div class="d-inline-block">
                            ...
                            <div class="card border-3 border-top border-top-primary">
                                <div class="card-body">
                             <?php                    
                            $rt = mysqli_query($conn,"SELECT * FROM complaint WHERE complainant_id='".$_SESSION['id']."' AND status = 2");
                            $num1 = mysqli_num_rows($rt);
                            {?>
                                    <div class="d-inline-block">
