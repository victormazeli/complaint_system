        ...
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Tariff Plans</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="cusTable">
                    <div class="card">
                        <h5 class="card-header">Manage Tariff plans</h5>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <?php
                                    $count = 1;
                                    $cq=mysqli_query($conn,"select * from tariff");
                                    while($row=mysqli_fetch_array($cq)){
                                        ...
                                        <?php include('includes/tariff_modal.php'); ?>
                                    <?php } ?>
                                    </tbody>
