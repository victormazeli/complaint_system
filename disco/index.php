...
$ret=mysqli_query($conn,"SELECT * FROM disco WHERE username='$username' and password='$password'");
...
<head>
    ...
    body {
        ...
        padding-top: 50px;
        padding-bottom: 50px;
        background-image: url("../assets/images/disco.jpg");
...
<body>
    ...
    <!-- ============================================================== -->
        <div class="splash-container">
          ...
          <h2 style="text-align:center; color: white; background-color: #5969ff;">DISCO <br> LOGIN PAGE</h2>
        <div class="card ">
