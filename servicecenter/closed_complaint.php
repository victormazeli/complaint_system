...
<body>
 ...
 <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Closed Complaints</h5>
                            <div class="card-body">
                                    ...
                                    <table table width="100%" class="table table-striped table-bordered table-hover" id="cusTable">
                                       ...
                                       <tbody>
                                            <?php
                                                $cq=mysqli_query($conn,"SELECT complaint.complaint_id, complaint.complaint_title, complainant.first_name, complainant.last_name FROM complaint INNER JOIN complainant ON complaint.complainant_id=complainant.complainant_id where status = '2' AND location='$location'");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button type="button" class="btn btn-rounded btn-success">Closed</button></td>
                                                        <td>
