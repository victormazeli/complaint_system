...
<body>
 ...
 <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header">Complaints In Progress</h3>
                            <div class="card-body">
                                    ...
                                    <table table width="100%" class="table table-striped table-bordered table-hover" id="cusTable">
                                       ...
                                       <tbody>
											<?php
												$cq=mysqli_query($conn,"SELECT complaint.complaint_id, complaint.complaint_title, complaint.date_reg, complainant.first_name, complainant.last_name FROM complaint INNER JOIN complainant ON complaint.complainant_id=complainant.complainant_id where status = '1' AND location='$location'");
                                           ...
                                           //$cq = mysqli_query($conn, "SELECT * FROM complaint where status = '2'");
												...
												?>
													...
													<tr>
													    ...
													    <td><button type="button" class="btn btn-rounded btn-info">In Progress</button></td>
                                                        <td>
