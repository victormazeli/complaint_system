...
{
$sql=mysqli_query($conn,"SELECT password FROM  complainant where password='".$_POST['password']."' && username='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{ 
 $con=mysqli_query($conn,"update complainant set password='".$_POST['newpassword']."', date_modified='$date' where username='".$_SESSION['login']."'");
...
//Log Code...
$log = "INSERT INTO `log` VALUES ('', '$username', 'Change Password', '$date', 'commplainant')";
