                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">NERC Dashboard</h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg- col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Overall Complaint Details</h5>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-12 col-lg- col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">AEDC Complaint Information</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                        </div>
                                    </div>
                            ...
                            <?php $com0 = mysqli_query($conn, "SELECT * FROM complaint WHERE status=0 ");
                           $notProcess = mysqli_num_rows($com0);

                           $com1 = mysqli_query($conn, "SELECT * FROM complaint WHERE status=1");
                           $Process = mysqli_num_rows($com1);

                           $com2 = mysqli_query($conn, "SELECT * FROM complaint WHERE status=2");
                           $Closed = mysqli_num_rows($com2); ?>
                               ...
                               <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="nerc_chart" style="height: 420px;"></div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Complaints by Status</h5>
                                    <div class="card-body">
                                        <div id="nerc_chart2" style="height: 420px;"></div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Complaints by Status</h5>
                                    <div class="card-body">
                                        <div id="nerc_chart3" style="height: 420px;"></div>
                                    </div>
                                </div>
                            </div>
