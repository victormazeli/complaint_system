...
$ret=mysqli_query($conn,"SELECT * FROM nerc WHERE username='$username' and password='$password'");
...
<head>
    ...
    body {
        ...
        padding-top: 50px;
        padding-bottom: 50px;
        background-image: url("../assets/images/nerc.png");
...
<body>
    ...
    <div class="splash-container">
          ...
          <h2 style="text-align:center; color: white; background-color: #5969ff;">NERC <br> LOGIN PAGE</h2>
        <div class="card ">
